...
const LoginPage = () => {
  ...
  return (
    <>
      <SEO
        title="Log In"
        description="Log in to your account to get quotes, read reviews and hire trusted professionals for your home services, handyman services, home cleaning, moving, and more with Procure."
        keywords="Procure, log in, trusted professionals, home services, handyman services, home cleaning, moving, get quotes, read reviews"
      />
