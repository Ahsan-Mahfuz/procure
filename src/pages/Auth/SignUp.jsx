...
const SignUp = () => {
  ...
  return (
    <>
      <SEO
        title="Sign Up"
        description="Create an account to get quotes, read reviews and hire trusted professionals for your home services, handyman services, home cleaning, moving, and more with Procure."
        keywords="Procure, sign up, trusted professionals, home services, handyman services, home cleaning, moving, get quotes, read reviews"
      />
      <div className="poppins fixed inset-0 h-screen flex text-white flex-col lg:flex-row">
